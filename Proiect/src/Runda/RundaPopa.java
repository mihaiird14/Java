...
public class RundaPopa extends Runda{

    public RundaPopa(){
        super("Popa de inima rosie");
    }
    ...
    public void startRunda(List<Player> jucatori,List<Carte>pachetCarti,List<Integer>scoruriJoc) {
        ...
        for(int i=0;i<13;i++){
            ...
            while(cnt<4) {
                ...
                if(semnJucat.toString().equals("I.ROSIE") && valJucata.toString().equals("K")){
                    nrIR+=1;
                }
                try {
                    Thread.sleep(1000);
            ...
            switch(jucatorStart){
                case 0:
                    scoruriJoc.set(0,scoruriJoc.get(0)-(nrIR*150));
                    break;
                case 1:
                    scoruriJoc.set(1,scoruriJoc.get(1)-(nrIR*150));
                    break;
                case 2:
                    scoruriJoc.set(2,scoruriJoc.get(2)-(nrIR*150));
                    break;
                case 3:
                    scoruriJoc.set(3,scoruriJoc.get(3)-(nrIR*150));
                    break;
            }
            if(nrIR==1){
                i=13;
