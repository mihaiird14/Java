...
public class RundaDame extends Runda{
    ...
    public void startRunda(List<Player> jucatori,List<Carte>pachetCarti,List<Integer>scoruriJoc) {
        ...
        for(int i=0;i<13;i++){
            ...
            while(cnt<4) {
                ...
                if(valJucata.toString().equals("Q")){
                    nrIR+=1;
                }
                try {
                    Thread.sleep(1000);
            ...
            switch(jucatorStart){
                case 0:
                    scoruriJoc.set(0,scoruriJoc.get(0)-(nrIR*25));
                    break;
                case 1:
                    scoruriJoc.set(1,scoruriJoc.get(1)-(nrIR*25));
                    break;
                case 2:
                    scoruriJoc.set(2,scoruriJoc.get(2)-(nrIR*25));
                    break;
                case 3:
                    scoruriJoc.set(3,scoruriJoc.get(3)-(nrIR*25));
                    break;
            }
            try {
                Thread.sleep(1000);
